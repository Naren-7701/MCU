    ...
    else if(phase==5)
    {
        ...
        $('#ph5sel').on('change',function() 
        {
            ...
            else if(movie==3)
            {
                ...
                $("#nextxt").append("");
                $("#plotxt").append("The High.Evol wants to create a Perfect Society, thus he experiments on various Creatures. One such Subject is 89P13 (Rocket Racoon), High.Evol was impressed by Rocket's intelligence but he wants to create better creatures than Rocket, thus he betrays him. Rocket comes to know about the true intentions of High.Evol, manages to escape after losing his friends. In present Day, he is attacked by Adam Warlock and is almost pushed towards his Death, the Guardians along with Gamora (Ravager) has to find the Pass-Key and save Rocket's Life. They go to Counter-Earth (Similar to Earth) to face High.Evol. The Planet is Destroyed, the Guardians are split. Along with the help of Kraglin and Cosmo from Knowhere they have to Stop High.Evol. Some of the Guardians have to part ways. The New Guardians of Galaxy Team with their New Captain will continue saving the Galaxy from different Threats.");
                $("#text").show();
                $("#mcubut").click(function(){$("#mcuyear").fadeToggle(150)})
                $("#parbut").click(function(){$("#partxt").fadeToggle(150)})
                $("#prebut").click(function(){$("#prevtxt").fadeToggle(150)})
