    ...
    $('#phsel').on('change',function() 
    {
        ...
        if(phase==1)
        {
            ...
            $('#ph1sel').on('change',function() 
            {
                ...
                if(movie==1)
                {
                    ...
                    $("#parallel").append(" -");
                    $("#prev").append(" Captain Marvel, Captain America The First Avenger");
                    $("#next").append(" Iron Man 2, Avengers");
                    $("#text").append(" Tony Stark is a Philanthrophist, Playboy, Billionaire who was captured by a Group of Terrorists in Afganistan. Thus he makes a Suit from Box of Scraps to escape from there and eventually find who is the Main reason behind his murder attempt.");
                    $("#text").show(300);
                }
                else if(movie==2)
                {
                    ...
                    $("#parallel").append(" Captain America First Avenger, Thor, Iron Man 2");
                    $("#prev").append(" Iron Man");
                    $("#next").append(" Avengers");
                    $("#text").append(" Bruce Banner is a Brilliant Scientist. He falls in love with the Daughter of General Thadeaus Ross (Betty Ross). Ross performs an experiment on Bruce to transform him into a Super Soldier (instead, he turns into Hulk). To stop him, another Army Officer was sent. Instead he was smacked down by Hulk. To get vengence, he transformed himself into  a Super Soldier (Abomination). The Final face off is Hulk vs Abomination.");
                    $("#text").show(300);
                }
                else if(movie==3)
                {
                    ...
                    $("#image").show();
                    $("#mcu").prop("value","MCU YEAR: 2011 (Fury's Busy Week)");
                    $("#parallel").append(" Incredible Hulk, Thor, Captain America First Avenger");
                    $("#prev").append(" Iron Man");
                    $("#next").append("Avengers, Iron Man 3");
                    $("#text").append(" A Russian Scientist (Ivan Vanko) whose father was betrayed by Howard Stark wants to get revenge on Tony Stark. He prepares his own armor with the Help of Hammer Industries. Stark is lavish, irresponsible with his Technology. The Arc Reactor slowly poisons him. Thus he has to fix the Arc Reactor and stop Ivan.");
                    $("#text").show();
                }
                else if(movie==4)
                {
                    ...
                    $("#image").show("fast");
                    $("#mcu").prop("value","MCU YEAR: 2011 (Fury's Busy Week)");
                    $("#parallel").append(" Incredible Hulk, Thor, Iron Man 2");
                    $("#prev").append(" Eternals");
                    $("#next").append(" Agent Carter, Captain Marvel, Avengers");
                    $("#text").append(" The Movie narrates about Steve Rogers aka Captain America (The First Avenger), on his transformation from a Skinny Lad to a Super Soldier. He participates in The Second World War, Battle against Nazi's (Red Skull) who found the Tesseract that has infinite energy, which can destroy the World. Steve and Peggy Carter love each other. Steve sacrifices himself to save the world, freezes into ice for 70 years.");  
                    $("#text").show(300);
                }
                else if(movie==5)
                {
                    ...
                    $("#image").show("fast");
                    $("#mcu").prop("value","MCU YEAR: 2011 (Fury's Busy Week)");
                    $("#parallel").append(" Incredible Hulk, Iron Man 2, Captain America First Avenger");
                    $("#prev").append(" -");
                    $("#next").append(" Avengers");
                    $("#text").append(" The Movie takes the MCU to cosmic Side (Asgrad), ruled by Norse Mythology Gods, Thor (Son of Odin) has to prove his valour to his Father, to become the Next King. His Initial Failiure Expelled him to Earth (Midgard), where he falls in love with a Scientist (Jane Foster). Thor has to stop his Cunning brother (Loki) from taking the Throne of Asgard."); 
                    $("#text").show(300);
                }
                else
                {
        ...
        else if(phase==2)
        {
            ...
            $('#ph2sel').on('change',function() 
            {
                ...
                else if(movie==4)
                {
                    ...
                    $("#image").show("fast");
                    $("#mcu").prop("value","MCU YEAR: 2014");
                    $("#parallel").append(" I am Groot");
                    $("#prev").append(" -");
                    $("#next").append(" Guardians of Galaxy Volume 2");
                    $("#text").append(" A Bunch of Unknown Space pirates, are put together in a prison due to a unavoidable situation. They have to work as a Team and escape from there. The Power Stone is in huge demand. Ronin (A space lord who works for Thanos), wants to destroy the Entire Planet (Xandar), with the help of Power Stone. The Guardians have to plan appropriately, and stop Ronin from destroying the Galaxy.");
                    $("#text").show(300);
                }
                else if(movie==5)
                {
                    ...
                    $("#parallel").append(" Antman 1");
                    $("#prev").append(" Captain America Winter Soldier, Iron Man 3, Thor Dark World");
                    $("#next").append(" Captain America Civil War, Thor Ragnarok");
                    $("#text").append(" Tony Stark wants to create an AI (Ultron), to safeguard and prepare a Suit of Armor around the World. The Plan goes wrong and an evil AI is created which wants to take control of the entire world. Hydra experiments Wanda and Quicksilver initially work with Ultron to take revenge against Stark. But later, they realise the true intention of Ultron. The Avengers along with Wanda, Quick Silver and Vision, has to save the world from the Ultron's Invasion");
                    $("#text").show(300);
                }
                else
                {
        ...
        else if(phase==3)
        {
            ...
            $('#ph3sel').on('change',function() 
            {
                ...
                else if(movie==5)
                {
                    ...
                    $("#mcu").prop("value","MCU YEAR: 2017");
                    $("#parallel").append(" -");
                    $("#prev").append(" Avengers Age of Ultron, Doctor Strange");
                    $("#next").append(" Avengers Infinity War");
                    $("#text").append(" Thor goes to Asgrard, where an imposter Loki is ruling. In search of Odin, Thor comes to know about Hela (Godess of Death, Odin's Daughter), who wants vengence, destroy Asgard. Thor goes to Sarkar, fights Hulk and forms a Team (Revengers), to fight against Hela, and save the people of Asgard.");
                    $("#text").show(300);
                }
                else if(movie==6)
                {
                ...
                else if(movie==7)
                {
                    ...
                    $("#parallel").append(" -");
                    $("#prev").append(" Captain America First Avenger");
                    $("#next").append(" Iron Man 1, Avengers Endgame");
                    $("#text").append(" Carol Danvers is a Fighter Jet Pilot, who works for the US Airforce. In a unexpected accident with the Tesseract, she becomes powerful. The Kree soldiers erased her memory and used her as a weapon against the Skrulls, to protect their home planet Hala. Danvers comes to know about their true intention via Supreme Intelligence. Now Nick Fury and Captain Marvel has to save Skrull's from Kree Invasion.");
                    $("#text").show(300);
                }
                else if(movie==8)
                {
                    ...
                    $("#image").show("fast");
                    $("#mcu").prop("value","MCU YEAR: 2018");
                    $("#parallel").append(" Antman and the Wasp");
                    $("#prev").append(" Captain America Civil War, Black Panther, Spider Man Homecoming, Black Widow, Guardians of Galaxy Volume 2, Thor Ragnarok, Doctor Strange");
                    $("#next").append(" Avengers Endgame");
                    $("#text").append("  The Biggest face off by all the Super heroes, against one Common Enemy (Thanos). The Mad Titan wants six Infinity stones to snap and wipe half of the Universe from existence. All the Avengers group together and try their best to defend the Stones, untill their efforts go in vain.");
                    $("#text").show(300);
                }
                else if(movie==9)
                {
                    ...
                    $("#image").show("fast");
                    $("#mcu").prop("value","MCU YEAR: 2018");
                    $("#parallel").append(" Avengers Infinity War");
                    $("#prev").append(" Captain America Civil War");
                    $("#next").append(" Avengers Endgame");
                    $("#text").append(" Hank Pym along with Antman and the Wasp, wants to rescue Janet Van Dyne (Wife of Hank Pym) from the Quantum Realm, where she is stuck for the past 30 years. Antman lost his suit and is house arrested for violating Sokovia Accords. (Ghost) who is a victim of Hank's failiure experiment, wants her Vengence. A Group of low profile Salesmen wants Pym's technology to sell and gain Profit. In the end Antman and Wasp has to deal with all the above issues.");
                    $("#text").show(300);
                }
                else if(movie==10)
                {
        ...
        else if(phase==4)
        {
            ...
            if(movie==1)
            {
                ...
                $("#parallel").append(" -");
                $("#prev").append(" Avengers Endgame");
                $("#next").append(" Doctor Strange in the Multiverse of Madness, The Marvels");
                $("#text").append(" Nine days after the Endgame Battle, Wanda Maximoff visits SWORD Headquartes, where she comes to know that Vision (Dead from Infinity War) is torn apart and used for Research purpose. Unable to withstand the grief, Wanda creates a Hex (Illusion Town called West View) with actual people and an imaginary Vision. SWORD tries to intrude and warn Wanda from outside the Hex. Agatha, a witch and resident of West view is well aware about the Situation and wants to Steal Wandas power.");
                $("#text").show(300);
            }
            else if(movie==2)
            {
            ...
            else if(movie==12)
            {
                ...
                $("#prev").append(" Guardians of Galaxy Volume 1");
                $("#next").append(" Guardians of Galaxy Volume 2");
                $("#text").append(" A mini TV series about Groot's development from young to Teenage. Takes place between Guardians Vol 1, Guardians Vol 2.");
                $("#text").show(300);
            }
            else if(movie==13)
            {
            ...
            else if(movie==16)
            {
                ...
                $("#image").show("fast");
                $("#mcu").prop("value","MCU YEAR: 2024");
                $("#parallel").append(" Hawkeye");
                $("#prev").append(" Spider Man Far From Home, Spider Man 1,2,3 (Raimi) The Amazing Spider Man 1,2 Venom 1,2");
                $("#next").append(" Doctor Strange in the Multiverse of Madness");
                $("#text").append(" As Spiderman's identity is known to the Entire world, Peter Parker is on the run. DRDO arrested him for killing Mysterio, the damages caused by Stark Drones. Peter faces harsh criticism from his colleagues. He approaches Dr.Strange to spell a cast that everyone has to forget Peter Parker as Spiderman. The Spell is messed up, unleashes few villian from the multiverse. Dr. Strange wants to send them back, where as Peter wants to fix them. This leads to a conflict. Norman Osborn shows his Alter ego (Goblin) and attacks them. Peter has to sacrifice, take vengence. He is interrupted by two other Spiderman who want to give correct guidance. The Final face off is the Spiderman's trying to fix the Villains.");
                $("#text").show(300);
            }
            else
            {
    ...
    else if(phase==5)
    {
        ...
        $('#ph5sel').on('change',function() 
        {
            ...
            else if(movie==3)
            {
                ...
                $("#next").append(" -");
                $("#text").append(" The High Evolutionary wants to create a Perfect Society, thus he experiments on various Creatures across the Universe. One such Subject is 89P13 (Rocket Racoon), High.Evol was impressed by Rocket's intelligence but he wants to create better creatures than Rocket, thus he betrays him. Rocket comes to know about the true intentions of High.Evol, manages to escape after losing his friends. In present Day, he is attacked by Adam Warlock (Son of Ayesha from the Soverign) and is almost pushed towards his Death, the Guardians along with Gamora (Ravager) has to find the Pass-Key and save Rocket's Life. They go to Counter-Earth (Similar to Earth) where they have to face High.Evol. The Planet is Destroyed, the Guardians are split. Along with the help of Kraglin and Cosmo from Knowhere they have to Stop High.Evol, save Different Life Forms. Some of the Guardians have to part ways. The New Guardians of Galaxy Team with their New Captain will continue saving the Galaxy from different Threats.");
                $("#text").show(300);
            }
            else if(movie==4)
            {
    ...
    else
    {
        ...
        $('#cansel').on('change',function() 
        {
            ...
            if(movie==1)
            {
                ...
                $("#parallel").append(" -");
                $("#prev").append(" Captain America First Avenger");
                $("#next").append(" Captain Marvel, Iron Man 1");
                $("#text").append("Life changes for Peggy Carter after her boyfriend Steve Rogers is feared dead. Now she leads a dual life by doing administrative work as well as working as a S.H.I.E.L.D. agent under Howard Stark. After Howard's Death she becomes the Director of SHIELD.");
                $("#text").show(300);
            }
            else if(movie==2)
            {
