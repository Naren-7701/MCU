    ...
    else if(phase==5)
    {
        ...
        $('#ph5sel').on('change',function() 
        {
            ...
            else if(movie==2)
            {
                ...
                $("#nextxt").append("");
                $("#plotxt").append("In 1995, when the Skrulls came to Earth as Refugees, Nick Fury made a Promise to find a New Home for the Skrulls in return of their Help as Spies. Nearly after 30 years, when Fury failed to fulfill the Promise, Gravik the New Skrull General with his Council and Young Rebellion Army want to take control of the Earth as their new Home. At the same time Millions of Skrull are in the Planet, disguised as Spies, Top Position Leaders. Nick Fury along with the Help of Talos, other Secret Agents have to stop Gravik and the Secret Invasion.");
                $("#text").show();
                $("#mcubut").click(function(){$("#mcuyear").fadeToggle(150)})
                $("#parbut").click(function(){$("#partxt").fadeToggle(150)})
                $("#prebut").click(function(){$("#prevtxt").fadeToggle(150)})
